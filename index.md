...
is a programming language for writing physical simulations. Ebb programs are _performance portable_: they can be efficiently executed on both CPUs and GPUs.  Ebb is embedded in the [Lua](www.lua.org) programming language using [Terra](terralang.org).
