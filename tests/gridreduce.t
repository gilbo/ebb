...
local liszt count_one1 ( c : rel1 )
  L.assert(c.ones == 1)
  glob_one_count_1 += c.ones
end
local liszt count_one2 ( c : rel2 )
  L.assert(c.ones == 1)
  glob_one_count_2 += c.ones
end
local liszt count_one3 ( c : rel3 )
  L.assert(c.ones == 1)
  glob_one_count_3 += c.ones
end

local liszt count_raw1 ( c : rel1 )
  glob_raw_count_1 += 1
end
local liszt count_raw2 ( c : rel2 )
  glob_raw_count_2 += 1
end
local liszt count_raw3 ( c : rel3 )
  glob_raw_count_3 += 1
end
