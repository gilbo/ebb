...
------------------------------------------------------------------------------
-- Reference Path Strings: Liszt Root & Working Directory                   --
------------------------------------------------------------------------------
...
-- Compute the Liszt root directory
-- Super Hacky!
local LISZT_ROOT_DIR_CACHED
(function()
...
PN.liszt_root_str = function() return LISZT_ROOT_DIR_CACHED end
...
-- throw a comprehensible error if the liszt_root contains
