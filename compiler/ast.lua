...
-- non syntactic lvalues (i.e. these will not be generated by the parser)
...
-- non syntactic lvalues
inherit(Scalar, 		 LValue)
inherit(Field, 			 LValue)
inherit(FieldAccess, LValue)
