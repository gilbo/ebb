...
function A.is_ast(obj)
  return type(obj) == 'table' and obj.is_liszt_ast
end
...
A.Expression:NewKind('VectorIndex',      {'vector','index'})
...
A.Expression:NewKind('FieldAccess')
A.Expression:NewKind('Global')
A.Expression:NewKind('Cast')
...
A.Statement :NewKind('DeleteStatement',  {'row'})
...
function A.VectorIndex:pretty_print (indent)
  indent = indent or ''
