...
local terra run_simulation (iters : uint64)
  ...
  C.cudaMemcpy([&opaque](head_ddata), [&opaque](M.edges.head.data),
                                      tsize, C.cudaMemcpyHostToDevice)
  C.cudaMemcpy([&opaque](tail_ddata), [&opaque](M.edges.tail.data),
                                      tsize, C.cudaMemcpyHostToDevice)
  C.cudaMemcpy([&opaque](flux_ddata), [&opaque](M.vertices.flux.data),
                                      fsize, C.cudaMemcpyHostToDevice)
  C.cudaMemcpy([&opaque](jaco_ddata), [&opaque](M.vertices.jacobistep.data),
                                      fsize, C.cudaMemcpyHostToDevice)
  C.cudaMemcpy([&opaque](temp_ddata), [&opaque](M.vertices.temperature.data),
                                      fsize, C.cudaMemcpyHostToDevice)
  C.cudaMemcpy([&opaque](posn_ddata), [&opaque](posn_data),
                                      3*fsize, C.cudaMemcpyHostToDevice)
