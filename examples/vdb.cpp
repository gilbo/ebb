...
VDB_CALL int vdb_point_fn_stride(int N, void * p, int stride) {
	return vdb_print('p',N,stride,3,p);
}	

VDB_CALL int vdb_point_fn(int N, void * p) { 
	return vdb_point_fn_stride(N,p,3*sizeof(float));
}
...
VDB_CALL int vdb_line_fn_stride(int N, void * p, int stride) {
	return vdb_print('l',N,stride,6,p);
}
VDB_CALL int vdb_line_fn(int N, void * p) {
	return vdb_line_fn_stride(N,p,sizeof(float) * 6);
}
...
VDB_CALL int vdb_normal_fn_stride(int N, void * p, int stride) {
	return vdb_print('n',N,stride,6,p);
}
VDB_CALL int vdb_normal_fn(int N, void * p) {
	return vdb_normal_fn_stride(N,p,sizeof(float) * 6);
}
...
VDB_CALL int vdb_triangle_fn_stride(int N, void * p, int stride) {
	return vdb_print('t',N,stride,9,p);
}
VDB_CALL int vdb_triangle_fn(int N, void * p) {
	return vdb_triangle_fn_stride(N,p,sizeof(float) * 9);
}
