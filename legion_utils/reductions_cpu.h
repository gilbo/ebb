...
// register max on vectors
void register_reduction_global_max_float_vec2(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_vec2(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_vec2(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_vec3(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_vec3(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_vec3(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_vec4(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_vec4(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_vec4(legion_reduction_op_id_t redop);

// register max on matrices
void register_reduction_global_max_float_mat2x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat2x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat2x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat2x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat2x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat2x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat2x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat2x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat2x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat3x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat3x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat3x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat3x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat3x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat3x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat3x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat3x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat3x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat4x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat4x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat4x2(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat4x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat4x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat4x3(legion_reduction_op_id_t redop);
void register_reduction_global_max_float_mat4x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_double_mat4x4(legion_reduction_op_id_t redop);
void register_reduction_global_max_int32_mat4x4(legion_reduction_op_id_t redop);
...
// register min on vectors
void register_reduction_global_min_float_vec2(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_vec2(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_vec2(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_vec3(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_vec3(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_vec3(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_vec4(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_vec4(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_vec4(legion_reduction_op_id_t redop);

// register min on matrices
void register_reduction_global_min_float_mat2x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat2x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat2x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat2x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat2x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat2x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat2x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat2x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat2x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat3x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat3x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat3x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat3x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat3x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat3x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat3x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat3x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat3x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat4x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat4x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat4x2(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat4x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat4x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat4x3(legion_reduction_op_id_t redop);
void register_reduction_global_min_float_mat4x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_double_mat4x4(legion_reduction_op_id_t redop);
void register_reduction_global_min_int32_mat4x4(legion_reduction_op_id_t redop);
